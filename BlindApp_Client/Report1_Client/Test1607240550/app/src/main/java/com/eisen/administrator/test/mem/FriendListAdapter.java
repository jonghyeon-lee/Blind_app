 ...
 */
public class FriendListAdapter extends BaseAdapter { // 리스트 뷰의 아답타
    Context context;
    int layout;
    ...
    public FriendListAdapter(Context context, ArrayList<HashMap<String, String>> al, int layout) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        name.setText(dataSet.get("name").toString());
        state.setText(dataSet.get("mobno").toString());
